        ...
        {articles.map((art, index) => (
          ...
          >
            <div>
              ...
              {/* Title */}
              <h3 style={{ fontSize: '1.25rem', color: 'var(--text-primary)', fontWeight: 600, marginBottom: '12px', lineHeight: 1.4 }}>
                {art.title}
              </h3>
            ...
            >
              ...
              <ArrowUpRight size={14} style={{ color: 'var(--text-secondary)', marginLeft: 'auto' }} />
            </div>
          </div>
        ))}
      </div>

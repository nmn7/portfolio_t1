...
export default function MyStory() {
  ...
  return (
    <section id="story" data-section="story" style={{ position: 'relative' }}>
      ...
      <div style={{ position: 'relative', display: 'grid', gridTemplateColumns: '1fr', gap: '32px', paddingLeft: '24px' }}>
            ...
            >
              ...
              <div
                style={{
                  ...
                  height: '40px',
                  borderRadius: '50%',
                  backgroundColor: isActive ? '#3B82F6' : '#0B0B0B',
                  border: isActive ? '2px fill #3B82F6' : '1px solid rgba(255,255,255,0.1)',
              ...
              <div
                ...
                style={{
                  ...
                  backgroundColor: isActive ? 'rgba(59, 130, 246, 0.02)' : 'rgba(11,11,11,0.6)',
                  transition: 'all 0.4s ease',
                  display: 'flex',
              ...
              >
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '8px' }}>
                  <h3 style={{ fontSize: '1.4rem', color: isActive ? '#3B82F6' : '#F5F5F5' }}>
                    {step.title}
                  </h3>
                  <span style={{ fontSize: '0.8rem', color: '#A3A3A3', textTransform: 'uppercase', letterSpacing: '0.1em' }}>
                    Phase 0{index + 1}
                  </span>
                </div>
                
                <h4 style={{ fontSize: '1rem', color: '#F5F5F5', fontWeight: 500, fontStyle: 'italic' }}>
                  {step.subtitle}
                </h4>

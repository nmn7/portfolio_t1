...
export default function EngineeringPlayground() {
  ...
  const items: PlaygroundItem[] = [
    ...
    },
    {
      ...
      icon: <Network size={20} />,
      summary: 'Eliminating downstream database hits for frequent operations.',
      explanation: 'Traffic requests are evaluated by CDN servers. Missed responses are evaluated inside express app routers which hit a high-speed Redis database cache memory before executing SQL statements.',
      diagram: (
        <svg viewBox="0 0 400 160" style={{ width: '100%', height: '100%', overflow: 'visible' }}>
          <rect x="10" y="60" width="70" height="40" rx="8" fill="rgba(255,255,255,0.04)" stroke="rgba(255,255,255,0.15)" strokeWidth="1.5" />
          <text x="45" y="85" fill="#F5F5F5" fontSize="10" textAnchor="middle">Client Traffic</text>
          
          <rect x="130" y="60" width="90" height="40" rx="8" fill="rgba(59, 130, 246, 0.08)" stroke="#3B82F6" strokeWidth="1.5" />
          <text x="175" y="80" fill="#F5F5F5" fontSize="10" textAnchor="middle">Express Application</text>
          <text x="175" y="92" fill="#3B82F6" fontSize="8" textAnchor="middle">Proxy Router</text>
          
          <rect x="270" y="20" width="110" height="40" rx="8" fill="rgba(34, 197, 94, 0.08)" stroke="#22C55E" strokeWidth="1.5" />
          <text x="325" y="45" fill="#F5F5F5" fontSize="10" textAnchor="middle">Redis Memory Cache</text>
          
          <rect x="270" y="100" width="110" height="40" rx="8" fill="rgba(6, 182, 212, 0.08)" stroke="#06B6D4" strokeWidth="1.5" />
          <text x="325" y="125" fill="#F5F5F5" fontSize="10" textAnchor="middle">MySQL Database</text>

          <line x1="80" y1="80" x2="130" y2="80" stroke="rgba(255,255,255,0.2)" strokeWidth="1.5" />
          <path d="M 220 80 L 245 80 L 245 40 L 270 40" fill="none" stroke="#3B82F6" strokeWidth="1.5" />
          <path d="M 220 80 L 245 80 L 245 120 L 270 120" fill="none" stroke="#3B82F6" strokeWidth="1.5" />
        </svg>
      )
    }
  ];
            ...
            return (
              <button
                ...
                style={{
                  ...
                  textAlign: 'left',
                  cursor: 'pointer',
                  border: isActive ? '1px solid rgba(59, 130, 246, 0.4)' : '1px solid rgba(255, 255, 255, 0.04)',
                  backgroundColor: isActive ? 'rgba(59, 130, 246, 0.03)' : 'rgba(11, 11, 11, 0.4)',
                  outline: 'none',
                  display: 'flex',
                  alignItems: 'center',
                  gap: '16px',
              ...
              >
                <div 
                  style={{
                    ...
                    height: '40px',
                    borderRadius: '8px',
                    backgroundColor: isActive ? '#3B82F6' : 'rgba(255,255,255,0.02)',
                    display: 'flex',
                    alignItems: 'center',
                ...
                <div>
                  ...
                  <h3 style={{ fontSize: '1.1rem', color: '#F5F5F5', marginTop: '2px' }}>
                    {item.title}
                  </h3>
                </div>
              </button>
        ...
        <div style={{ gridColumn: 'span 7' }} className="glass-panel">
          <div style={{ padding: '36px', height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', gap: '32px' }}>
            <div>
              ...
              <h2 style={{ fontSize: '1.6rem', color: '#F5F5F5', marginBottom: '12px' }}>
                {currentItem.title}
              </h2>
              <p className="body-normal" style={{ fontSize: '0.95rem', lineHeight: 1.5, color: '#F5F5F5' }}>
                {currentItem.summary}
              </p>
            </div>
            ...
            <div style={{ borderTop: '1px solid rgba(255,255,255,0.06)', paddingTop: '20px' }}>
              <h4 style={{ fontSize: '0.9rem', color: '#A3A3A3', display: 'flex', alignItems: 'center', gap: '6px', marginBottom: '6px' }}>
                <Code size={14} />
                How It Works
              </h4>
              <p style={{ fontSize: '0.85rem', color: '#A3A3A3', lineHeight: 1.5 }}>
